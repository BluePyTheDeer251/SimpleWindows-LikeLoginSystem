print("Welcome to Pygle, Enter your username and password.")
...
if username is True:
    ...
    print("No user found with that username, I guess you wrote it wrong or just tried to hack someone.")
print(password)
if password is True:
    print("Ok, go in, I just don't know how to make a JavaScript (or even HTML/CSS or PHP) UI.")
else:
    print("Are you trying to hack someone to get their personal info? You have been reported to the FBI.")
